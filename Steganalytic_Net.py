...
TEST_DATASET_DIR = args.TEST_DIR
  ...
  train_dataset = torchvision.datasets.ImageFolder(root='TestDataset/train', transform=train_transform)
  valid_dataset = torchvision.datasets.ImageFolder(root='TestDataset/valid', transform=valid_transform)
  test_dataset = torchvision.datasets.ImageFolder(root='TestDataset/test', transform=test_transform)
###
